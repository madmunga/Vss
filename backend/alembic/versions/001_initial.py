...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("USER", "PROFESSIONAL", "ADMIN", name="user_role"), nullable=False, server_default="USER"),
    ...
    op.create_table(
        ...
        sa.Column("addiction_type", sa.Enum("ALCOHOL","DRUGS","GAMBLING","GAMING","SEX","FOOD","SMOKING","OTHER", name="addiction_type"), nullable=False),
        sa.Column("description", sa.Text),
        sa.Column("required_tier", sa.Enum("S","A","B", name="community_tier"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("specialty", sa.Enum("PSYCHIATRIST","PSYCHOLOGIST","COUNSELOR","THERAPIST","ADVISOR", name="professional_specialty"), nullable=False),
        sa.Column("tier", sa.Enum("S","A","B", name="professional_tier"), nullable=False),
        sa.Column("vetting_status", sa.Enum("PENDING","APPROVED","REJECTED", name="vetting_status"), nullable=False, server_default="PENDING"),
    ...
    op.create_table(
        ...
        sa.Column("community_id", UUID(as_uuid=True), sa.ForeignKey("communities.id"), nullable=False),
        sa.Column("tier", sa.Enum("S","A","B", name="assignment_tier"), nullable=False),
        sa.Column("is_active", sa.Boolean, nullable=False, server_default="true"),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True, default=uuid.uuid4),
        sa.Column("user_id", UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False, unique=True),
        sa.Column("tier", sa.Enum("S","A","B", name="subscription_tier"), nullable=False),
        sa.Column("stripe_subscription_id", sa.String, unique=True),
        sa.Column("stripe_customer_id", sa.String),
        sa.Column("status", sa.Enum("ACTIVE","CANCELLED","PAST_DUE","TRIALING", name="subscription_status"), nullable=False, server_default="TRIALING"),
